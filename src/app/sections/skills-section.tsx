      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        {skills.map((skill, index) => (
          <Card key={index} className="text-center group hover:shadow-lg transition-shadow">
            <CardHeader>
              <div className="mx-auto bg-primary/10 p-4 rounded-full group-hover:bg-accent/20 transition-colors">
                <skill.icon className="h-10 w-10 text-primary group-hover:text-accent transition-colors" />
              </div>
            </CardHeader>
            <CardContent>
