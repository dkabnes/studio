...
export default function HomeSection() {
  ...
  return (
    <section id="home" className="relative w-full overflow-hidden bg-gradient-to-br from-secondary via-background to-background pt-24 pb-16 md:pt-32 md:pb-24">
          ...
          <div className="relative flex items-center justify-center -order-1 lg:order-1">
            {profileImage && (
              <div className="relative w-[300px] h-[300px] md:w-[450px] md:h-[450px]">
                <div className="absolute inset-0 bg-gradient-to-tr from-accent/30 to-primary/30 rounded-full blur-2xl"></div>
                <Image
